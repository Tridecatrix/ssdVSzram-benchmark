...
# total size for the benchmark (16GB for faster testing)
...
# Block sizes to test (multiple sizes)
...
# IO engines
sync_ioengines=("sync")
async_ioengines=("libaio")

# Compression percentages to test (subset for faster testing)
compress_percentages=(0 25 50 75 100)
